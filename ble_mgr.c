...
static void Usage(const char *progName)
{
    ...
    printf("  -b<9600|57600|115200>   Set uart baud rate\n");
    return;
}
            ...
            case 'b':
	          /* set uart speed */
                if(strcmp(optarg, "57600") == 0) {
                  ...
                  gpBLEMgmtTaskCtx->uart.speed  = B9600;
                } else {
...
static void TaskCtxInit(void)
{
    ...
    gpBLEMgmtTaskCtx->programName = "elevatorMgmt";
...
static void UartInit(char *device)
{
    ...
    else if(B9600 == gpBLEMgmtTaskCtx->uart.speed)
    {
       speedname = "9600";
    }
